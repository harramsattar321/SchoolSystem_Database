...
class Application(tk.Tk):
    ...
    def create_widgets(self):
        ...
        # Insert Button
        self.insert_button = tk.Button(self, text="Insert", command=lambda: self.show_menu("Insert"), font=self.custom_font, bg="grey", fg="white")
        self.insert_button.grid(row=1, column=0, sticky="nsew")
        
        # Delete Button
        self.delete_button = tk.Button(self, text="Delete", command=lambda: self.show_menu("Delete"), font=self.custom_font, bg="grey", fg="white")
        self.delete_button.grid(row=2, column=0, sticky="nsew")
        
        # Modify Button
        self.modify_button = tk.Button(self, text="Modify", command=lambda: self.show_menu("Modify"), font=self.custom_font, bg="grey", fg="white")
        self.modify_button.grid(row=3, column=0, sticky="nsew")
        
        # Search Button
        self.search_button = tk.Button(self, text="Search", command=lambda: self.show_menu("Search"), font=self.custom_font, bg="grey", fg="white")
        self.search_button.grid(row=4, column=0, sticky="nsew")
        
        # Display Button (new button)
        self.display_button = tk.Button(self, text="Display", command=lambda: self.show_menu("Display"), font=self.custom_font, bg="grey", fg="white")
    ...
    def show_menu(self, action):
        ...
        for option in options:
            button = tk.Button(menu_window, text=option, command=lambda opt=option: self.menu_action(opt, action), bg="grey", fg="white")
